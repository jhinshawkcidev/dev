...
- This script lacks the functionality to fine-tune site columns (this would push the spreadsheet to having over 20 columns)- it's really only good for "template-izing" your site columns based on the above table, then diving into each site column and configuring from there.
